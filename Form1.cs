...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            lstGroupName.Add("Факультет анализа рисков и экономической безопасности имени профессора В.К.Сенчагова");

            lstGroupName.Add("Факультет бизнес-анализа и аудита");
            lstGroupName.Add("Факультет государственного управления и финансового контроля");
lstGroupName.Add("Факультет логистики");
            lstGroupName.Add("Факультет международного туризма, спорта и гостиничного бизнеса");
            lstGroupName.Add("Факультет международных экономических отношений");
            lstGroupName.Add("Факультет менеджмента");
            lstGroupName.Add("Факультет налогов и налогообложения");
            lstGroupName.Add("Факультет прикладной математики и информационных технологий");
            lstGroupName.Add("Факультет социологии и политологии");
            lstGroupName.Add("Факультет финансовых рынков имени профессора В.С.Геращенко");
            lstGroupName.Add("Факультет экономики и финансов топливно-энергетического комплекса");
            lstGroupName.Add("Финансово-экономический факультет");
            lstGroupName.Add("Юридический факультет");
            ...
            учебнаягруппаBindingSource1.DataSource = lstGroupName;
